...
export default function HeroPortrait({ image }: HeroPortraitProps) {
  return (
    <div className="hero-portrait relative z-30 w-full max-w-[420px] mx-auto">
      <div className="relative aspect-[4/5] overflow-hidden border border-white/15 bg-neutral-900">
        <img
          src={image || '/images/srihari-profile.jpg'}
          alt="Portrait"
        ...
        <div className="absolute bottom-4 left-4 text-[10px] tracking-[0.25em] text-white/60">
